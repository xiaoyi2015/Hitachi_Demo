    ...
    */
    ...
    public void resetAll(){
        ...
        for (int i=getFirstVisiblePosition();i<=getLastVisiblePosition();i++) {
            recycle(getChildAt(i - getFirstVisiblePosition()).findViewById(swipeFrontView), i);
        }
    }

    /**
     * Close all opened items except one (by Cristiano)
     */
    public void closeOpenedItemsExcept(int exception_position) {
        touchListener.closeOpenedItems(exception_position);
    }
